...
DfPayloads POST authenticated
    [Tags]           dfpayloads    authenticated    POST    happy
    ...
    Given An authenticated POST request to /v1/dfpayloads/${NOTICE_NUM}/${CORRELATION} with payload "{}"
...
DfPayloads GET authenticated
    [Tags]           dfpayloads  authenticated    GET    unhappy
    ...
    Given An authenticated GET request expecting HTTP 500 from /v1/dfpayloads/${NOTICE_NUM}/${CORRELATION}
