...
*** Settings ***
Documentation    DfPayloads GET endpoint
Library      JSONLibrary
...
DfPayloads GET authenticated
    [Tags]           dfpayloads  authenticated    GET    happy
    [Documentation]  Should return DF payload
    ...
    ...              Example: ``$ https digitalforms-viirp-api-c220ad-dev.apps.silver.devops.gov.bc.ca/digitalforms-viirp/v1/dfpayloads/${NOTICE_NUM}/${CORRELATION} --auth "user:$PASSWORD"``
    Given An authenticated GET request to /v1/dfpayloads/${NOTICE_NUM}/${CORRELATION}
...
DfPayloads DELETE authenticated
    [Tags]           dfpayloads    authenticated    DELETE    unhappy
    ...
    Given An authenticated DELETE request expecting HTTP 500 from /v1/dfpayloads/${NOTICE_NUM}/${CORRELATION}
...
DfPayloads PUT authenticated
    [Tags]           dfpayloads    authenticated  PUT    unhappy
    [Documentation]  Should return unsupported
    ...
    ...              Example: ``$ https PUT digitalforms-viirp-api-c220ad-dev.apps.silver.devops.gov.bc.ca/digitalforms-viirp/v1/dfpayloads/${NOTICE_NUM}/${CORRELATION} --auth user:$PASSWORD``
    Given An authenticated PUT request expecting HTTP 500 from /v1/dfpayloads/${NOTICE_NUM}/${CORRELATION}
    Then Response code is HTTP  500
...
DfPayloads POST authenticated
    [Tags]           dfpayloads    authenticated    POST    unhappy
    [Documentation]  Should return unsupported
    ...
    ...              Example: ``$ https POST digitalforms-viirp-api-c220ad-dev.apps.silver.devops.gov.bc.ca/digitalforms-viirp/v1/dfpayloads/${NOTICE_NUM}/${CORRELATION} --auth user:$PASSWORD``
    Given An authenticated POST request expecting HTTP 500 from /v1/dfpayloads/${NOTICE_NUM}/${CORRELATION} with payload ""
    Then Response code is HTTP  500
