...
# Example:
#
#   > .\Get-NextAvailableVipsNumber.ps1 -number_type adp -specificed_number 00123456 -environment dev
#
...
#
#    > .\Get-NextAvailableVipsNumber.ps1 <RECORD_NUMBER>
#    > .\Get-NextAvailableVipsNumber.ps1 00123456
#
...
#
#    > .\Get-NextAvailableVipsNumber.ps1
#
...
#
#    > .\Get-NextAvailableVipsNumber.ps1 [ADP|IRP|UL|IMP] <RECORD_NUMBER>
#    > .\Get-NextAvailableVipsNumber.ps1 adp 00123456
#
...
#
#    > .\Get-NextAvailableVipsNumber.ps1 [ADP|IRP|UL|IMP]
#    > .\Get-NextAvailableVipsNumber.ps1 adp
#
