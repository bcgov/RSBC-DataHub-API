...
*** Settings ***
Documentation    Prohibitions POST endpoint
Library      JSONLibrary
...
Prohibitions POST authenticated
    [Tags]           prohibitions    authenticated    POST    happy
    ...
    Given An authenticated POST request to /v1/prohibitions/ ${NOTICE_NUM}/${CORRELATION} with payload ""
...
Prohibitions GET authenticated
    [Tags]           prohibitions  authenticated    GET    unhappy
    ...
    Given An unauthenticated GET request expecting HTTP 500 from /v1/prohibitions/ ${NOTICE_NUM}/${CORRELATION}
