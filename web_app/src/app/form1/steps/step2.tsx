...
const Step2 = forwardRef((props: Props, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    validate() {
      ...
      if (step2Data.applicantRoleSelect !== "driver") {
        ...
        hasErrors += validate(
          "applicantEmailConfirm",
          step2Data.applicantEmailConfirm
        );
        hasErrors += validate("applicantLastName", step2Data.applicantLastName);
        hasErrors += validate(
          "applicantFirstName",
          step2Data.applicantFirstName
        );
        hasErrors += validate(
          "controlDriverCityTown",
          step2Data.controlDriverCityTown
        );
        hasErrors += validate(
          "controlDriverProvince",
          step2Data.controlDriverProvince ?? ""
        );
        hasErrors += validate(
          "controlDriverPostalCode",
          step2Data.controlDriverPostalCode
        );
        hasErrors += validate(
          "applicantPhoneNumber",
          step2Data.applicantPhoneNumber
        );
      }
    ...
    if (e.target.files?.length) {
      ...
      if (await checkVirusScanner(fileContent)) {
        ...
        setStep2DataErrors({
          ...setStep2DataErrors,
          fileUploadErrorText:
            "There is a problem with the uploaded document. Please recheck the documents",
        });
  ...
  const validateApplicantName = (
    ...
    if (
      (field === "applicantFirstName" || field === "driverFirstName") &&
      step2Data.applicantRoleSelect === ""
    ) {
  ...
  const getErrorMessage = (field: string) => {
    switch (field) {
      case "applicantFirstName":
        return "Please enter the applicant's first name";
      case "applicantLastName":
        return "Please enter the applicant's last name";
  ...
  const validatePhoneNumber = (value: string, errors: Step2DataErrors) => {
    ...
    if (value) {
      errors.applicantPhoneNumber = phNumberRegex.exec(value)
        ? ""
        : "Missing or incorrect value";
    } else
      errors.applicantPhoneNumber =
        "Please provide an area code and phone number.";
  };

  const validateEmailAddress = (
    value: string,
    errors: Step2DataErrors,
    field: "applicantEmailAddress" | "applicantEmailConfirm"
  ) => {
    const emailAddressRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
    if (field === "applicantEmailAddress") {
      if (value)
        errors.applicantEmailAddress = emailAddressRegex.exec(value)
          ? ""
          : "Incorrect email format, enter in format name@example.com";
      else errors.applicantEmailAddress = "Please enter a valid email address.";
    } else if (value)
      errors.applicantEmailConfirm =
        value && value === step2Data.applicantEmailAddress
          ? ""
          : "Missing or incorrect value";
    else
      errors.applicantEmailConfirm =
  ...
  const validatePostalCode = (value: string, errors: Step2DataErrors) => {
    ...
    const postalCodeRegex2 =
      /^[ABCEGHJ-NPRSTVXYabceghj-nprstvxy]\d[ABCEGHJ-NPRSTV-Zabceghj-nprstv-z]\d[ABCEGHJ-NPRSTV-Zabceghj-nprstv-z]\d$/;
    if (value)
      errors.controlDriverPostalCode =
        postalCodeRegex1.exec(value.trimEnd()) ||
        postalCodeRegex2.exec(value.trimEnd())
          ? ""
          : "Enter in format A1A 1A1.";
    else errors.controlDriverPostalCode = "Please enter a postal code.";
  };
  ...
  const validate = (fieldName: string, value: string) => {
    ...
    props.step2DatatoSend(step2Data);
    if (
      Object.values(errors).every((value) => value === null || value === "")
    ) {
    ...
    >
      <div id="page2img2">
        <Grid
          ...
          sm={10}
          lg={12}
          sx={{ padding: "1px", paddingBottom: "20px" }}
        >
          <strong
            style={{
              fontSize: "16px",
        ...
        <Grid item xs={8} sx={{ padding: "1px" }}>
          <FormField
            ...
            tooltipContent={
              <p>
                You can submit your application, or a lawyer or person you
                authorize can do it on your behalf.
              </p>
            }
          ...
          >
            <RadioGroup
              ...
              value={step2Data.applicantRoleSelect}
        ...
        {step2Data.applicantRoleSelect === "driver" && (
          <Grid item xs={8} sx={{ padding: "1px" }}>
            ...
            >
              <RadioGroup
                id="represented-by-lawyer-field"
                aria-labelledby="demo-radio-buttons-group-label"
                name="representedByLawyer"
                value={step2Data.representedByLawyer}
                onChange={handleChange}
                onBlur={handleBlur}
              >
                <FormControlLabel
        ...
        {(step2Data.applicantRoleSelect === "lawyer" ||
          ...
          >
            <Grid container spacing={2}>
              ...
              <Grid item xs={5} sx={{ padding: "1px" }}></Grid>
            </Grid>
            <Grid
              container
              spacing={1}
              style={{ paddingTop: "30px", paddingBottom: "1px" }}
            >
              <Grid item xs={8} sx={{ padding: "1px" }}>
                <FormField
                  id="attach-consent"
                  ...
                  tooltipContent={
                    <p>
                      ...
                      you to send and receive documents on their behalf.
                    </p>
                  }
        ...
        {(step2Data.applicantRoleSelect === "lawyer" ||
          (step2Data.applicantRoleSelect === "driver" &&
            step2Data.representedByLawyer === "yes")) && (
          <strong
            style={{
              fontSize: "16px",
              paddingBottom: "20px",
        ...
        >
          <TextField
            ...
            value={step2Data.applicantFirstName}
            onChange={handleChange}
            onBlur={handleBlur}
          ></TextField>
        </FormField>
        <FormField
          ...
          tooltipContent={
            <p>
              If you&apos;re the driver, enter your last name exactly as it is
              on your licence.
            </p>
          }
        ...
        >
          <TextField
            ...
            value={step2Data.applicantLastName}
            onChange={handleChange}
            onBlur={handleBlur}
          ></TextField>
        </FormField>
      ...
      <div id="page3img1">
        <FormField
          ...
          tooltipContent={
            <p>
              Please provide an area code and phone number where RoadSafetyBC
              can contact you.
            </p>
          }
        ...
        <FormField
          ...
          tooltipContent={
            <p>
              Please enter a valid email address to receive emails with your
              next steps.
            </p>
          }
        ...
        >
          <TextField
            ...
            value={step2Data.applicantEmailAddress}
            onChange={handleChange}
            onBlur={handleBlur}
          ></TextField>
        </FormField>
        <FormField
          ...
          tooltipContent={
            <p>Please confirm the email address entered above.</p>
          }
        ...
        >
          <TextField
            ...
            value={step2Data.applicantEmailConfirm}
            onChange={handleChange}
            onBlur={handleBlur}
          ></TextField>
        </FormField>
      ...
      <div id="page3img2">
        ...
        {((step2Data.applicantRoleSelect === "driver" &&
          ...
          <div>
            ...
            >
              <TextField
                id="driver-first-name-field"
                style={{ paddingLeft: "5px" }}
                inputProps={{ maxLength: "35" }}
                variant="outlined"
                name="driverFirstName"
                value={step2Data.driverFirstName}
                onChange={handleChange}
                onBlur={handleBlur}
              ></TextField>
            </FormField>
            <FormField
              ...
              tooltipContent={
                <p>
                  Enter the driver&apos;s last name exactly as it appears on the
                  driver&apos;s licence.
                </p>
              }
            ...
            >
              <TextField
                ...
                variant="outlined"
                name="driverLastName"
                value={step2Data.driverLastName}
                onChange={handleChange}
                onBlur={handleBlur}
              ></TextField>
            </FormField>
        ...
        <FormField
          ...
          tooltipContent={
            <Image
              src="/assets/images/BC Driver License Number.png"
              width={280}
              height={180}
              alt="Info"
              style={{
        ...
        >
          <TextField
            id="bc-driver-license-no-field"
            style={{ paddingLeft: "5px" }}
            variant="outlined"
            name="driverBcdl"
            value={step2Data.driverBcdl}
            onChange={handleChange}
            onBlur={handleBlur}
          ></TextField>
        </FormField>
        ...
        >
          Address where you want the decision mailed:
        </strong>
        <FormField
          id="address"
          labelText="Address"
        ...
        >
          <TextField
            id="address-field"
            style={{ paddingLeft: "5px", minWidth: "400px" }}
            variant="outlined"
            name="streetAddress"
        ...
        >
          <TextField
            ...
            style={{ paddingLeft: "5px" }}
            variant="outlined"
            name="controlDriverCityTown"
            value={step2Data.controlDriverCityTown}
            onChange={handleChange}
            onBlur={handleBlur}
          ></TextField>
        </FormField>
      ...
      <div id="page4img1">
        ...
        >
          <Select
            labelId="province"
            id="province-field"
            name="controlDriverProvince"
            value={step2Data.controlDriverProvince}
        ...
        <FormField
          ...
          tooltipContent={
            <p>
              Please enter a valid postal code in either format A1A 1A1 or
              A1A1A1.
            </p>
          }
        ...
        >
          <TextField
            ...
            style={{ paddingLeft: "5px" }}
            variant="outlined"
            name="controlDriverPostalCode"
            value={step2Data.controlDriverPostalCode}
            onChange={handleChange}
            onBlur={handleBlur}
          ></TextField>
        </FormField>
