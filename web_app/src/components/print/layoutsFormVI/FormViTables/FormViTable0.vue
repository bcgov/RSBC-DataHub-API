        ...
        <div class="row outer_table_class" style="font-size:8pt; margin:0rem 0 0 0;">
            <table class="border-0 border-dark" style="width:100%; line-height:0.75rem;">                
                <tr>
                    ...
                    <td  style="width:3.5%;" />                    
                    <td  style="width:21.5%; line-height:0.65rem;">
                        <table class="float-right">
                            <tr> 
                                <th class="text-right">NOTICE OF IMPOUNDMENT</th>                                                           
                            </tr>
                            <tr> 
                                <td class="text-right">Vehicle Impoundment</td>
                            </tr>
                            <tr> 
                                <td class="text-right">Section 215.46/251 MVA</td>
                            </tr>
                            <tr> 
                                <td />
                            </tr>
...
export default class FormViTable0 extends Vue {
