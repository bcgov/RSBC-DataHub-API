<template>
    <div style="display:inline-block;">
        ...
        <div style="display:inline-block">
            <div :style="{position: 'absolute', marginTop:marginTop, fontWeight: textWeight,  fontSize: textSize, color:textColor, minWidth: textwidth}">{{text}}</div> 
...
export default class UnderlineForm extends Vue {
    ...
    @Prop({required: true, default:'#151515'})
    textColor!: string;
