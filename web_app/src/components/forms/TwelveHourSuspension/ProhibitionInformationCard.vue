...
<form-card title="Prohibition">
  <div>
    <form-row>
      <radio-field id="prohibition_type_12hr" fg_class="col-sm-6" rules="required"
    ...
    <form-row>
      <text-field id="file_number" fg_class="col-sm-2" rules="required">Agency File Number</text-field>
