...
<div v-if="visible" class="form-group" :class="fg_class">
  <validation-provider :rules="rules" :name="id" v-slot="{ errors, required }">
    ...
    <multiselect :value="getAttributeValue(path, id)" @input="updateProvince" :disabled="disabled || hasFormBeenPrinted" :id="id" tag-placeholder="That isn't an option" label="objectDsc" track-by="objectCd" placeholder="Search for a Province or State" :options="getArrayOfProvinces">
    </multiselect>
